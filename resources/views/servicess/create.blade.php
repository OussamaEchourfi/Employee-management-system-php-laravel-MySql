...
@section('title', 'Services Management System | Créer un Service')
    ...
    <div class="page-header mb-4">
        <div class="header-content">
            ...
            <div class="header-info">
                <h1 class="header-title">Créer un Nouveau Service</h1>
                <p class="header-subtitle">Ajoutez un nouveau service à votre organisation</p>
            </div>
        ...
        <div class="col-lg-8">
            <div class="content-card">
                ...
                <div class="card-body-modern">
                    ...
                    <form method="POST" action="{{ route('servicess.store') }}" enctype="multipart/form-data" class="modern-form">
                        @csrf
