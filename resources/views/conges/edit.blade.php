    ...
    <div class="page-header mb-4">
        <div class="header-content">
            ...
            <div class="header-info">
                <h1 class="header-title">Modifier Congés</h1>
        ...
        <div class="col-lg-8">
            ...
            <div class="content-card">
                ...
                <div class="card-body-modern">
                    <form method="POST" action="{{ route('conges.update', $conge->id) }}" enctype="multipart/form-data" class="modern-form">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="employID" id="employID" class="form-select @error('employID') is-invalid @enderror" required>
                                        ...
                                        @foreach($employes as $employe)
                                            <option value="{{ $employe->id }}" {{ old('employID', $conge->employID) == $employe->id ? 'selected' : '' }}>
                            ...
                            <div class="form-section">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="droitConge" id="droitConge" class="form-select @error('droitConge') is-invalid @enderror" required>
                                                ...
                                                <option value="Congé annuel" {{ old('droitConge', $conge->droitConge) == 'Congé annuel' ? 'selected' : '' }}>Congé annuel</option>
                                                <option value="Congé maladie" {{ old('droitConge', $conge->droitConge) == 'Congé maladie' ? 'selected' : '' }}>Congé maladie</option>
                                                <option value="Congé maternité" {{ old('droitConge', $conge->droitConge) == 'Congé maternité' ? 'selected' : '' }}>Congé maternité</option>
                                                <option value="Congé paternité" {{ old('droitConge', $conge->droitConge) == 'Congé paternité' ? 'selected' : '' }}>Congé paternité</option>
                                                <option value="Congé sans solde" {{ old('droitConge', $conge->droitConge) == 'Congé sans solde' ? 'selected' : '' }}>Congé sans solde</option>
                                                <option value="Autre" {{ old('droitConge', $conge->droitConge) == 'Autre' ? 'selected' : '' }}>Autre</option>
                                            </select>
                                            @error('droitConge')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="duree" id="duree" class="form-control @error('duree') is-invalid @enderror" 
                                                   value="{{ old('duree', $conge->duree) }}" min="1" max="365" required>
                                            @error('duree')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="dataDepart" id="dataDepart" class="form-control @error('dataDepart') is-invalid @enderror" 
                                           value="{{ old('dataDepart', $conge->dataDepart) }}" required>
                                    @error('dataDepart')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
