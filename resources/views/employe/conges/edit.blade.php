...
<head>
    ...
    <title>Modifier la Demande de Congé - {{ $employe->nomComplet }}</title>
            ...
            <div class="col-lg-8">
                <div class="form-card">
                    <div class="form-header">
                        ...
                        <p>Modifiez les informations de votre demande</p>
                    </div>
                    
                    <div class="form-body">
                        <form action="{{ route('employe.conges.update', $conge->id) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-select @error('droitConge') is-invalid @enderror" 
                                        ...
                                        <option value="Congé annuel" {{ old('droitConge', $conge->droitConge) == 'Congé annuel' ? 'selected' : '' }}>
                                            🏖️ Congé annuel
                                        </option>
                                        <option value="Congé maladie" {{ old('droitConge', $conge->droitConge) == 'Congé maladie' ? 'selected' : '' }}>
                                            🏥 Congé maladie
                                        </option>
                                        <option value="Congé maternité" {{ old('droitConge', $conge->droitConge) == 'Congé maternité' ? 'selected' : '' }}>
                                            👶 Congé maternité
                                        </option>
                                        <option value="Congé paternité" {{ old('droitConge', $conge->droitConge) == 'Congé paternité' ? 'selected' : '' }}>
                                            👨‍👩‍👧‍👦 Congé paternité
                                        </option>
                                        <option value="Congé formation" {{ old('droitConge', $conge->droitConge) == 'Congé formation' ? 'selected' : '' }}>
                                            📚 Congé formation
                                        </option>
                                        <option value="Congé sans solde" {{ old('droitConge', $conge->droitConge) == 'Congé sans solde' ? 'selected' : '' }}>
                                            💰 Congé sans solde
                                        </option>
                                        <option value="Autre" {{ old('droitConge', $conge->droitConge) == 'Autre' ? 'selected' : '' }}>
                                            🔧 Autre
                                        </option>
                                    </select>
                                    @error('droitConge')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="date" class="form-control @error('dataDepart') is-invalid @enderror" 
                                                   id="dataDepart" name="dataDepart" 
                                                   value="{{ old('dataDepart', $conge->dataDepart->format('Y-m-d')) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="date" class="form-control @error('dateRetour') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('dateRetour', $conge->dateRetour->format('Y-m-d')) }}" 
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control @error('motif') is-invalid @enderror" 
                                              ...
                                              placeholder="Décrivez en détail le motif de votre demande de congé..." required>{{ old('motif', $conge->motif) }}</textarea>
                                    @error('motif')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">
